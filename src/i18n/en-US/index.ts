...
export default {
  ...
  airports: {
    ...
    no_airports: 'No airports saved yet',
    empty_runways: 'No runways configured',
    confirm_delete: 'Delete this airport?',
    import_success: 'Airport(s) imported',
