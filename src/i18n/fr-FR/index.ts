...
export default {
  ...
  airports: {
    ...
    no_airports: 'Aucun aéroport enregistré',
  ...
  airport: {
    ...
    temperature_help:
      'la température du brief dans DCS est donnée pour le niveau de la mer. Retirez 2°C tous les 1000 pieds.',
    pressure: 'Pression',
  ...
  takeoff_info: {
    ...
    flaps: 'Volets',
    ptfs_help:
      'La vitesse de la turbine doit être vérifiée après environ 1 000 pieds de roulage pendant le décollage.',
    ...
    takeoff_index_help:
      'TakeOff Index est indiqué pour le cas où vous souhaitez lire les graphiques.',
    taxi_fuel: 'Carb. pour le Taxi (100 lbs/10 min)',
    taxi_fuel_help:
      "+ 200 lbs au pire pour le décollage et l'accélération à la vitesse de montée.",
  ...
  flight_phase: {
    ...
    optimum: {
      climb_speed:
        'Vitesses (x1000ft : IAS) : [SL: 200, 5: 195, 10: 190, 15: 185, 20: 180]',
      combat_ff: 'Débit Carb. Combat à 250 KIAS',
      speed_max_range:
        'Vitesse pour distance maximale est {speed} KIAS ( Idle, SB Fermés)',
      speed_max_range_help:
        'Carburant, temps and distance pour une descente en Penetration: 80 % core RPM, 200 KIAS, SB ouverts à 40% ',
    },

    alt_must_be_lower:
      "Altitude doit être inférieure à l'originale pour descendre	",
    alt_must_be_higher:
      "Altitude doit être supérieure à l'originale pour monter",
  },
  landing_info: {
    copy_takeoff_params: 'Copier les paramètres de décollage',
    gross_weight: 'Poids total',
    gross_weight_validator:
      "Le poids brut doit être supérieur au poids à vide et inférieur au poids d'atterrissage maximal.",
    single_engine: 'Un seul moteur  ',
    speed_brakes: 'Aerofreins',
    minimum_run: 'Distance roulage minimum',
    minimum_run_help:
      "Cochez pour voir la distance de roulage minimum et la vitesse d'atterrissage associée",
    ...
    landing_index_help:
      "L'indice d'atterrissage est affiché au cas où vous souhaiteriez consulter les cartes.",
  },
