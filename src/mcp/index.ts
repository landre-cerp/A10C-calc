...
server.tool(
  ...
  'Calculate the ground run distance for the A10C in feet',
  {
    takeoffIndex: z
      .number()
      .describe('Takeoff index, use a10c_takeoffIndex tool'),
    weight: z.number().describe('Weight of the aircraft in pounds'),
