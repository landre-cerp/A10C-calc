...
export const TouchdownSpeed = (landingConfig: ILandingConfiguration) => {
  return landingConfig.minspeed
    ? ApproachSpeed(landingConfig)
    : ApproachSpeed(landingConfig) - 10;
};
...
export const LandingGroundRoll = (landingConfig: ILandingConfiguration) => {
  ...
  groundRoll = RCR_landing_distance_flaps20.GetLinear(
    groundRoll,
    landingConfig.rcr,
  );
...
const vector_landingIndex = new CorrectionTable(
  ...
  new Map([
    ...
    [2000, new CorrectionVector([98.2, -0.359, 1.17e-3])],
    [4000, new CorrectionVector([91, -0.342, 1.29e-3])],
...
const headwind_landing_distance_flaps20 = new PosNegCorrectionTable(
  ...
  new CorrectionTable(
    'Tailwind Landing Distance Flaps 20',
    new Map([
